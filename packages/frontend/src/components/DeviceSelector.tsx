    ...
    <div className="flex items-center gap-2">
      ...
      <div className="flex gap-1 bg-gray-900 rounded p-1">
        <button
          ...
          className={`p-1.5 rounded transition-colors ${
            previewMode === 'web' ? 'bg-blue-600 text-white' : 'text-gray-400 hover:bg-gray-700'
          }`}
          title="Web"
        >
        ...
        <button
          ...
          className={`p-1.5 rounded transition-colors ${
            previewMode === 'ios' ? 'bg-blue-600 text-white' : 'text-gray-400 hover:bg-gray-700'
          }`}
          title="iOS"
        >
        ...
        <button
          ...
          className={`p-1.5 rounded transition-colors ${
            previewMode === 'android' ? 'bg-blue-600 text-white' : 'text-gray-400 hover:bg-gray-700'
          }`}
          title="Android"
        >
      ...
      <div className="relative">
        <button
          ...
          className="px-3 py-1.5 bg-gray-900 hover:bg-gray-700 text-gray-300 text-sm rounded transition-colors"
        >
          {currentDevice.name}
        </button>
        
        {showDevices && (
          <div className="absolute top-full right-0 mt-2 bg-gray-800 border border-gray-700 rounded shadow-lg z-20 min-w-[200px] max-h-[400px] overflow-y-auto">
            {devices
              ...
              .map((device) => (
                <button
                  ...
                  className={`w-full px-4 py-2 text-left text-sm hover:bg-gray-700 transition-colors ${
                    device.id === deviceFrame ? 'bg-blue-600/20 text-blue-400' : 'text-gray-300'
                  }`}
                >
                  <div>{device.name}</div>
      ...
      <button
        ...
        className="p-1.5 bg-gray-900 hover:bg-gray-700 text-gray-400 rounded transition-colors"
        title="Rotate"
      >
      ...
      <div className="flex items-center gap-1 bg-gray-900 rounded p-1">
        ...
        <span className="text-xs text-gray-400 px-2 min-w-[45px] text-center">{zoom}%</span>
        <button
